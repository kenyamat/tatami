RSpec.describe Tatami::Validators::Csv::HeaderValidator do
  describe '.validate' do
    ...
    context 'when invalid name' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /Invalid Header Name/) }
    end
    ...
    context 'when invalid number of children' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /children is invalid/) }
    end
  end
  ...
  describe '.validate_arrange' do
    ...
    context 'when there is no HttpRequest Actual' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /Arrange should have <HttpRequest Actual>/) }
    end
    ...
    context 'when there is invalid node' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /<Arrange> has unknown child./) }
    end

    context 'when there is no children' do
      let(:header) { Tatami::Models::Csv::Header.new(:name => 'Arrange', :depth => 0, :from => 0, :to => 0, :children => []) }
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /Arrange's children are not found/) }
    end
  end
  ...
  describe '.validate_http_request' do
    ...
    context 'when there is no BaseUri' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /Actual should have <BaseUri> as his child/) }
    end
    ...
    context 'when there is invalid child' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /Invalid Header Format./) }
    end
    ...
    context 'when BaseUri has child' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /<BaseUri> should have no children/) }
    end
    ...
    context 'when Headers has no child' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /Headers should have children./) }
    end
    ...
    context 'when Fragment has child' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /<Fragment> should have no children./) }
    end
  end
  ...
  describe '.validate_assertion' do
    ...
    context 'when invalid name' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /Invalid Header Name. Expected=Assertion/) }
    end
    ...
    context 'when there is no children' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /Assertion should have children./) }
    end
    ...
    context 'when Uri has child' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /<Uri> should have no children./) }
    end
    ...
    context 'when there is invalid child' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /<Assertion> has a unknown child. Name=XX/) }
    end
  end
  ...
  describe '.validate_contents' do
    ...
    context 'when contents has no Actual' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /Contents should have <Actual> as his child./) }
    end
    ...
    context 'when Name has child' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /<Name> should have no children./) }
    end
    ...
    context 'when there is invalid child' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /<Contents> has a unknown child./) }
    end
  end
  ...
  describe '.validate_contents_item' do
    ...
    context 'when there is invalid child' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /<Expected> has a unknown child. Name=XX/) }
    end
    ...
    context 'when there is no child' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /Expected should have children./) }
    end
  ...
  describe '.validate_not_nil' do
    ...
    context 'when not valid' do
      let(:header) { nil }
      let(:name) { 'Contents' }
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /Header <Contents> is not found./) }
    end
  end
  ...
  describe '.validate_depth_from_to' do
    ...
    context 'when invalid from/to' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /<Parent>'s From\/To is invalid./) }
    end
    ...
    context 'when invalid depth' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /<Child>'s Depth is invalid. Expected=0, Actual=-1/) }
    end
    ...
    context 'when invalid from' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /<Child>'s From is invalid. <Child>'s From=0, Child's parent's From=1/) }
    end
    ...
    context 'when invalid to' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /<Child>'s To is invalid. <Child>'s To=1, Child's parent's To=0/) }
    end
  end
  ...
  describe '.validate_having_children' do
    ...
    context 'when children is empty' do
      let(:header) { Tatami::Models::Csv::Header.new(:name => 'Parent', :depth => -1, :from => 0, :to => 4, :children => []) }
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /Parent's children are not found/) }
    end
    ...
    context 'when invalid count' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /Count of <Parent>'s children is invalid. Expected=3, Actual=2/) }
    end
  end
  ...
  describe '.validate_not_having_children' do
    ...
    context 'when there is children' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /<Parent> should have no children./) }
    end
  end
  ...
  describe '.validate_not_having_grand_children' do
    ...
    context 'when there is grand children' do
      ...
      it { expect { subject }.to raise_error(Tatami::WrongFileFormatError, /<Parent> should have no grand children./) }
    end
  end
end